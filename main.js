...
var StudentManagementSystem = /** @class */ (function () {
    ...
    StudentManagementSystem.prototype.addStudent = function (student) {
        ...
        console.log("Student ".concat(student.name, " added successfully!"));
    };
    StudentManagementSystem.prototype.displayAllStudents = function () {
        console.log("List of all students:");
        this.students.forEach(function (student) {
            student.displayDetails();
        });
    };
    StudentManagementSystem.prototype.searchStudentById = function (id) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    answers = _a.sent();
                    return [2 /*return*/, new Student(parseInt(answers.id), answers.name, parseInt(answers.age))];
            }
        });
    });
}
function promptSearchStudent() {
    return __awaiter(this, void 0, void 0, function () {
        var answer;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    answer = _a.sent();
                    return [2 /*return*/, parseInt(answer.id)];
            }
        });
    });
}
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var studentSystem, newStudent, searchId;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    studentSystem = new StudentManagementSystem();
                    return [4 /*yield*/, promptAddStudent()];
                case 1:
                    newStudent = _a.sent();
